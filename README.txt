...
Link to Git:https://github.com/MaximilianGrieser/WebEngineering2-DHBW/tree/gucci
...
To run the end to end test go to /frontend and run: ng e2e. (dont delete the admin user or this test will fail)
To run the backend test go to /backend/test and run: mocha app.test.js --exit. (this only works befor you use the calendar, as soon as you fill the db, this will fail).
